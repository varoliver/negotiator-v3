...
public class PrivatePost extends AuditEntity {
    ...
    public java.lang.String toString() {
        return "PrivatePost(postText=" + this.getPostText() + ", postStatus=" + this.getPostStatus() + ", postDate=" + this.getPostDate() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
    public PrivatePost(final Set<Attachment> attachments, final Person createdBy, final Person modifiedBy, final Request request, final Person person,
